...
//    DDLogVerbose(@"Request Path: %@, params %@", path, params);
//    //    (AFJSONResponseSerializer *)
//   return [[self sharedAFManager] GET:path parameters:nil success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject) {
//       complete(responseObject, nil);
...
//    return [[self sharedAFManager] POST:path parameters:params success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject) {
//        complete(responseObject, nil);
//    } failure:^(AFHTTPRequestOperation * _Nonnull operation, NSError * _Nonnull error) {
